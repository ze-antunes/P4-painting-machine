...
color laranja = color(221, 139, 32);
color azulEscuro = color(50, 73, 138);
color azulClaro = color(155, 193, 188);
color rosa   = color(238, 38, 119);
...
void draw() {
  ...
  for (PVector v : points) {
    ...
    if(key == '1'){
      for(int i = 0; i <= 100; i++){
      strokeColor = lerpColor(strokeColor, laranja, inc);
      inc += .01;
      }
    }
    stroke(strokeColor);
